/**
 * @todo(multi-site)
 * @todo(dynamic) can we make this configuration simpler?
 */
...
const seo = {
  ...
  description:
    'Jerome Fitzgerald (he/him) is an actor, comedian, & writer hailing from Pittsburgh, PA.',
...
export { nextSeo, sitemapExcludes, url }
