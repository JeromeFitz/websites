...
const blocks = {
  ...
  callout: {
    className:
      'border-l-[var(--gray-11)] bg-[var(--gray-a5)] m-4 rounded border-l-8 p-14 text-xl md:text-3xl 2xl:max-w-7xl',
  },
  column: {
  ...
  quote: {
    className:
      'border-l-[var(--accent-11)] bg-[var(--accent-5)] m-4 rounded border-l-8 p-6 text-xl md:p-14 md:text-3xl font-sans 2xl:max-w-7xl',
  },
  ...custom,
}
