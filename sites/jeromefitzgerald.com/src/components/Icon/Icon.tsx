...
const OpenInNewWindowIcon = ({ label, ...props }: IconProps) => (
  <AccessibleIcon label={label || "An icon representing opening a link in a new window.."}>
...
const PlusCircledIcon = ({ label, ...props }: IconProps) => (
  <AccessibleIcon label={label || "An icon representing a plus symbol that is circled."}>
...
const ReaderIcon = ({ label, ...props }: IconProps) => (
  <AccessibleIcon label={label || "An icon representing a page with words on it."}>
    <ReaderIconRadix role="img" {...props} />
  </AccessibleIcon>
);
...
const TrashIcon = ({ label, ...props }: IconProps) => (
  <AccessibleIcon
    label={
      label || "An icon representing a trash can. An outline of a garbage bin with a lidded handle."
    }
  >
