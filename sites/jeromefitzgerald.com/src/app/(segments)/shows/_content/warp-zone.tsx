        ...
        <ContentSection>
          <Flex gap={{ initial: "6", md: "8" }} direction="column" width="100%">
            ...
            <Text size={{ initial: "7", md: "8" }} weight="regular">
              <Em>
                Arcade Comedy Theater’s premier house team. With a weekly show for over 5 years.
              </Em>
            </Text>
            <Text size={{ initial: "5", md: "6" }} weight="regular">
              And an accompanying solo monthly show during where they would take their{" "}
              <Strong>JTS Brown</Strong> form to the absolute extreme. Audiences never knew what to
              expect, who to expect, when to expect… except a good time.
            </Text>
            ...
            <Text size={{ initial: "4", md: "5" }} weight="regular">
              ...
              <ul className="flex list-inside list-disc flex-col gap-2 py-2">
                <li>
                  Turned Arcade into a fully functioning Carnival complete with raffles, games
                  (pop-a-shot!), funnel-cake!
                </li>
                <li>
                  Did a show in an alley, because that is where everyone in Warp Zone liked to hang
                  out between shows and decided to bring the entire audience out.
                </li>
                <li>
