        ...
        <ContentSection>
          <Flex gap={{ initial: "6", md: "8" }} direction="column" width="100%">
            ...
            <Text size={{ initial: "7", md: "8" }} weight="regular">
              <Em>From Chicago to New York, with stops in Los Angeles, and Pittsburgh.</Em>
            </Text>
            <Text size={{ initial: "5", md: "6" }} weight="regular">
              ...
              <Strong>San Diego Improv Festival</Strong>. Separately, they have featured in comedy
              festivals in: <Em>Baltimore</Em>, <Em>Chicago</Em>, <Em>New York</Em>,{" "}
              <Em>Pittsburgh</Em>, <Em>San Francisco</Em>, <Em>Toronto</Em>, <Em>& more</Em>.
            </Text>
            <Text size={{ initial: "5", md: "6" }} weight="regular">
            ...
            <Text size={{ initial: "5", md: "6" }} weight="regular">
              ...
              <Anchor href="https://www.instagram.com/reillycoyooote">Anna C. Reilly</Anchor> on the
              capturing the essence.
            </Text>
            <Text size={{ initial: "5", md: "6" }} weight="regular">
              <>
                Known during their time in Pittsburgh as the world's most dangerous improv duo. They
                have since taken their show on the road because… well… they both moved away from
                there.
                <br />
                <br />
                Their farewell show had over <Code>25</Code> Special Guests, went over{" "}
                <Code>2</Code> hours long and was <Strong>Standing Room Only</Strong>. And since
                then you can catch them stuntin’ on stages in Chicago, LA, and NYC.
                <br />
                <br />
            ...
            <Text size={{ initial: "6", md: "7" }} weight="regular">
              <Em>
                ...
                <Anchor href="https://www.youtube.com/watch?v=biT1JGJTBAc">Vomiting Kermit</Anchor>
                {` `}
                himself.
              </Em>
            </Text>
