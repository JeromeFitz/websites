        ...
        <ContentSection>
          <Flex gap={{ initial: "6", md: "8" }} direction="column" width="100%">
            ...
            <Text size={{ initial: "5", md: "6" }} weight="regular">
              <Strong>Tha Deadies</Strong> and their special guests take you on a journey to the
              other side as they put the <Em>YOU</Em> in eulogy, the <Em>FUN</Em> in funeral, & the{" "}
              <Em>FU</Em> in fun.
            </Text>
            <Text size={{ initial: "4", md: "5" }} weight="regular">
              ...
              <ul className="flex list-inside list-disc flex-col gap-2 py-2">
                <li>
                  Performed at <Strong>Washington and Jefferson</Strong> college for their{" "}
                  <Em>“Philosophy of Death”</Em> class
                </li>
                <li>
                  Performed at <Strong>Carnegie Mellon University</Strong> many years as part of
                  their <Em>Detour Comedy Festival</Em>
                </li>
                <li>
              ...
              <br />
              <br />
              Though most years they had a monthly show at various venues. Most recently at{" "}
              <Anchor href="https://arcadecomedytheater.com">Arcade Comedy Theater</Anchor>.
            </Text>
            <GridWrapper>
            ...
            <Text size={{ initial: "6", md: "7" }} weight="regular">
              <Em>
                The Death Show re-animated itself in <Strong>Chicago</Strong> for a run at{" "}
                <Strong>iO</Strong>… and quite possibly in <Strong>NYC</Strong> at{` `}
