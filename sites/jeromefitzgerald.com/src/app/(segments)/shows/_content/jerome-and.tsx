    ...
    <>
        ...
        <ContentSection>
          <Flex gap={{ initial: "6", md: "8" }} direction="column" width="100%">
            <Text size={{ initial: "6", md: "7" }} weight="regular">
              The monthly comedy variety show where Jerome hosts a cavalcade of hilarous and
              talented friends.
            </Text>
            <Text size={{ initial: "5", md: "6" }} weight="regular">
              ...
              <Strong>Unplanned Comedy</Strong>. A volunteer audience member with no improv
              experience would become the star of the show.
            </Text>
            <Text size={{ initial: "7", md: "8" }} weight="regular">
              <Em>That tradition of working without a net has continued ever since.</Em>
            </Text>
          </Flex>
        </ContentSection>
      </GridWrapper>
      ...
      <GridWrapper>
        <ContentSection>
          <Flex gap={{ initial: "6", md: "8" }} direction="column" width="100%">
            <Text size={{ initial: "6", md: "7" }} weight="regular">
              The show quickly evolved to also include special guests with <Strong>a lot</Strong> of
              experience in improv, music, sketch, and stand-up. But due to schedules were folks
              Jerome did not get to perform with or see very often.
            </Text>
            <Text size={{ initial: "5", md: "6" }} weight="regular">
              In its latest iteration at <Strong>Arcade Comedy Theater</Strong> frequent
              collaborators{" "}
              <Em>
                <Anchor href="https://www.instagram.com/canticonti/">Alex Conti</Anchor>,{" "}
                <Anchor href="https://www.instagram.com/thisisnonsenseig/">Nonsense</Anchor>,{" "}
                <Anchor href="https://www.instagram.com/itsrainaingmen/">Raina Deerwater</Anchor>, &{" "}
                <Anchor href="https://www.instagram.com/saknasty/">Sara Kantner</Anchor>
              </Em>{" "}
              would weave absurdist humor through clowning and playful character sketches. Complete
              with touring musical acts and of course a clown on stage reading a book throughout the
      ...
      <GridWrapper>
        <ContentSection>
          <Flex gap={{ initial: "6", md: "8" }} direction="column" width="100%">
            <Text size={{ initial: "5", md: "6" }} weight="regular">
              It became parts SNL, parts bacchanal. (Sure that rhymes if you say it a certain way.)
            </Text>
            <Text color="mint" size={{ initial: "7", md: "8" }} weight="regular">
              <Em>
                Will the show ever return now that he has moved to NYC? All signs point to:{" "}
                <Strong>Probably</Strong>. (He has a lot of pals here too.)
              </Em>
            </Text>
            <Text size={{ initial: "5", md: "6" }} weight="regular">
              Big shout-out to the one and only{" "}
              <Strong>
                <Anchor href="https://www.instagram.com/nick_amarillo/">Nick Jaramillo</Anchor>
              </Strong>{" "}
