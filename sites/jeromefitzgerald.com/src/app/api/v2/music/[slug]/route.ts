...
type SLUG = "history-heavy-rotation" | "recent-played-albums" | "recent-played-tracks";
...
export async function GET(request: NextRequest, ctx: RouteContext<"/api/v2/music/[slug]">) {
