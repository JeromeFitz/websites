  ...
  return (
    <>
      <GridWrapper>
        ...
        <WrapperRight>
          ...
          <Text size={{ initial: "4", md: "6" }} weight="light">
            For the past <Code variant="ghost">10+</Code> years I’ve been directing, producing,
            writing, and performing sketch comedy, musicals, and improv. Feel free to check some out
            in the{" "}
            <Link asChild>
          ...
          <Text size={{ initial: "3", md: "5" }}>
            Based in <Strong>NYC</Strong> (<Text className="line-through">Pittsburgh, PA</Text>)
            I’ve had shows in <Em>Chicago</Em>, <Em>Cleveland</Em>, <Em>Detroit</Em>,{" "}
            <Em>New York City</Em>, <Em>Philadelphia</Em>, <Em>Pittsburgh</Em>, <Em>San Diego</Em>,{" "}
            <Em>San Francisco</Em>, and more.
          </Text>
          <Text size={{ initial: "3", md: "5" }}>
            Perhaps you have seen me in commercials for <Em>AT&T</Em>, <Em>Google</Em>, or{" "}
            <Em>Sucrets</Em>. On the jumbotron before games for the <Em>Pittsburgh Pirates</Em> at
            PNC Park. Or featured in{` `}
            <Em>The Onion</Em>. (It’s okay if not though.)
          </Text>
          <Text size={{ initial: "5", md: "7" }}>
            I’ve also been extremely fortunate to take courses from some of the funniest people in
            the comedy world and as a result – <Strong>thee world</Strong>:
          </Text>
          <Text size={{ initial: "3", md: "5" }}>
      ...
      <GridWrapper>
        ...
        >
          <Flex direction="column" justify="start" py="2" pr="2" gap={{ initial: "4", md: "6" }}>
            <Text size={{ initial: "4", md: "6" }} color="pink">
              <Em>
            ...
            <Text size={{ initial: "3", md: "5" }}>
              Well, it should go without saying at this point that I am a big fan of comedy. And
              that I like to stare at books, and zone out to music.
            </Text>
          </Flex>
        </Box>
      </GridWrapper>
              ...
              <Flex gap="4" direction="column">
                ...
                <Flex gap="6" direction="column">
                  ...
                  <LinkButton
                    ...
                    textComponent={
                      <CurrentHome disabled headline="" subline="No Upcoming Events…" />
                    }
                    icon={<TicketIcon />}
                    size="3"
                    variant="soft"
...
const ModuleCredits = ({ data }: { data: any }) => {
  return (
    <>
      {loop.map((l, i) => {
        return (
          <Flex direction="column" width="100%" key={`credits-${i}`}>
...
export { ModuleAbout, ModuleCredit, ModuleCredits, ModuleHome, ModuleImageGallery, ModuleShow };
