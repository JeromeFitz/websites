...
const menus: NavigationMenuItems[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: '/events/2025/03/14/the-latchkey-kids',
        id: '//events/2025/03/14/the-latchkey-kids',
        isActive: true,
        isActiveMobileOverride: false,
        keywords: ['improv', 'latchkey', 'kids'],
        title: 'Latchkey Kids: FRI 03/14',
        titleDescription: 'Latchkey Kids: FRI 03/14',
      },
      {
        href: '/events',
        icon: ListBulletIcon,
