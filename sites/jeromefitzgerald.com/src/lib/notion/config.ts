...
const blocks = {
  bulleted_list: {
    className: "my-2 flex list-inside list-disc flex-col py-2 font-sans text-base text-5 md:text-5",
  },
  bulleted_list_item: {
  ...
  numbered_list: {
    className: "my-2 flex list-inside list-decimal flex-col py-2 font-sans text-base",
  },
  numbered_list_item: {
    className: "mb-3 leading-tight",
  },
  paragraph: {
    className: "mb-4 text-5 font-normal leading-normal break-words font-sans 2xl:max-w-7xl",
  },
  quote: {
    className:
