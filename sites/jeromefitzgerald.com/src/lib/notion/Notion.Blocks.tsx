...
import { blocks as blocksDefault, OBJECTS, TYPES } from './config.default'
...
function NotionBlocks({
  ...
  const { object, results, type } = data.value[0]
  ...
  // console.dir(`isListItem: ${isListItem ? 'y' : 'n'}`)
  // console.dir(`isBlockItem: ${isBlockItem ? 'y' : 'n'}`)
