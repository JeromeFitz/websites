...
const preload = ({ catchAll }: { catchAll: any }) => {
  // log(`${DEBUG_KEY} preload`, catchAll)
  void getNotionData({ catchAll })
}

// eslint-disable-next-line complexity
const getNotionData = cache(async ({ catchAll }: { catchAll: any }) => {
  // log(`${DEBUG_KEY} getNotionData`, catchAll)
