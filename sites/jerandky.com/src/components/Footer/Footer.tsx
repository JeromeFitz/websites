          ...
          <SectionContent>
                  ...
                  <div className={cx("col-span-12", "md:col-span-4", "")} key={`menu-${menu.id}`}>
                    ...
                    <ul>
                      ...
                      {menu?.items.map((item) => {
                        return (
                          <li
                            className={cx("mb-2 md:mb-0.5", item?.active && item?.className)}
              ...
              <SectionContent className="w-full md:w-full">
                <div className="flex flex-row items-start justify-start gap-1 py-4 align-text-bottom md:py-0">
                  ...
                  <span>
                    ...
                    This site is/was under development. But mostly propped up to provide RSS feeds.
                  </span>
                </div>
              </SectionContent>
            </SectionWrapper>
            <SectionWrapper>
              ...
              <SectionContent className="w-full pb-36 md:w-full md:pb-2">
                <div className="flex flex-row items-start justify-start gap-1 py-4 align-text-bottom md:py-0">
                  <span className="">© {new Date().getFullYear()} Nice Group of People, LLC</span>
                </div>
              </SectionContent>
            </SectionWrapper>
          </SectionContent>
