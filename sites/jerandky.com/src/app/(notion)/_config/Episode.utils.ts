...
function getEpisodeData(properties) {
  ...
  let venueTitle = getPropertyTypeDataEpisode(properties, "Rollup.Venues.Title") ?? "";
  if (venueTitle) {
  ...
  const data = {
    ...
    dayOfMonthOrdinal: getPropertyTypeDataEpisode(properties, "Date.DayOfMonthOrdinal"),
    ...
    podcastAppleId: getPropertyTypeDataEpisode(properties, "Rollup.Podcasts.Apple.ID"),
    podcastAppleUrl: getPropertyTypeDataEpisode(properties, "Rollup.Podcasts.Apple.URL"),
    podcastSlug: getPropertyTypeDataEpisode(properties, "Rollup.Podcasts.Slug"),
    podcastSpotifyId: getPropertyTypeDataEpisode(properties, "Rollup.Podcasts.Spotify.ID"),
    podcastSpotifyUrl: getPropertyTypeDataEpisode(properties, "Rollup.Podcasts.Spotify.URL"),
    ...
    seoImageDescription: getPropertyTypeDataEpisode(properties, "SEO.Image.Description"),
