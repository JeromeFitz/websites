...
function getPodcastData(properties) {
  ...
  const data = {
    ...
    dayOfMonthOrdinal: getPropertyTypeDataPodcast(properties, "Date.DayOfMonthOrdinal"),
    ...
    seoImageDescription: getPropertyTypeDataPodcast(properties, "SEO.Image.Description"),
