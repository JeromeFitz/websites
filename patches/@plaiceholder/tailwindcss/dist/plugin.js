...
var plugin__default = /*#__PURE__*/ _interopDefaultLegacy(plugin$1)
...
var makeSynchronous = (function_) => {
  return (...arguments_) => {
    const serializedArguments = v8__default['default']
      .serialize(arguments_)
      .toString('hex')
    ...
    const {
      ...
      stdout,
      stderr,
    } = childProcess__default['default'].spawnSync(process.execPath, ['-'], {
      input,
      encoding: 'utf8',
    ...
    const { error, result } = v8__default['default'].deserialize(
...
var plugin = plugin__default['default'](async (props) => {
