...
const data = {
  ...
  'dont-applaud-either-laugh-or-dont': {
    id: 'dont-applaud-either-laugh-or-dont',
    slug: 'dont-applaud-either-laugh-or-dont',
    title: 'Don’t Applaud. Either Laugh or Don’t',
    subtitle: 'at the Comedy Cellar',
    status: STATUS.PENDING.id,
  ...
  'the-life-and-death-of-ancient-cities': {
    id: 'the-life-and-death-of-ancient-cities',
    slug: 'the-life-and-death-of-ancient-cities',
  ...
  'furiously-happy': {
    ...
    subtitle: 'A Funny Book about Horrible Things',
    status: STATUS.PENDING.id,
    author: 'Jenny Lawson',
  },
  'lets-pretend-this-never-happened': {
    id: 'lets-pretend-this-never-happened',
    slug: 'lets-pretend-this-never-happened',
  ...
  'i-feel-bad-about-my-neck': {
    ...
    slug: 'i-feel-bad-about-my-neck',
    title: 'I Feel Bad about My Neck',
    subtitle: 'And Other Thoughts on Being a Woman',
    status: STATUS.PENDING.id,
    author: 'Nora Ephron',
  },
  'even-this-i-get-to-experience': {
    id: 'even-this-i-get-to-experience',
    slug: 'even-this-i-get-to-experience',
  ...
  'daddys-boy': {
    ...
    slug: 'daddys-boy',
    title: 'Daddy’s Boy',
    subtitle: 'A Son’s Shocking Account of Life with a Famous Father',
    status: STATUS.PENDING.id,
    author: 'Chris Elliott',
  },
  'is-everyone-hanging-out-without-me': {
    id: 'is-everyone-hanging-out-without-me',
    slug: 'is-everyone-hanging-out-without-me',
    title: 'Is Everyone Hanging Out Without Me?',
    subtitle: '(And Other Concerns)',
    status: STATUS.PENDING.id,
    author: 'Mindy Kaling',
  },
  'the-last-black-unicorn': {
    id: 'the-last-black-unicorn',
    slug: 'the-last-black-unicorn',
