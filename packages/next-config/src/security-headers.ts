...
const ContentSecurityPolicy = `
  ...
  script-src 'self' 'unsafe-eval' 'unsafe-inline' data: *.twitter.com *.youtube.com cdn.usefathom.com cdn.vercel-insights.com vercel.live *.${process.env.NEXT_PUBLIC__SITE};
